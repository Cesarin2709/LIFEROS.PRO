...
def dashboard_html(content, request: Request):
    ...
    <meta name="apple-mobile-web-app-title" content="Liferos">
    ...
    <a href="/">Inicio</a>
    <a href="/habits">Habitos</a>
    <div style="display:flex; align-items:center;">
        <a href="/finances" style="flex-grow:1;">Finanzas</a>
        <button onclick="toggle('sub-finanzas')" style="background:none; border:none; color:white; cursor:pointer; font-size:1.2em; padding:0 10px;">v</button>
    </div>
